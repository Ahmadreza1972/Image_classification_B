...
class Config:
    ...
    def _set_directories(self):
        ...
        # Model 1 directories
        if self._mixed_class_active:
            self._MODEL1_TR_DATA = os.path.join(self._DATA_DIR, "model1/Mixedmodel1_train.pth")
            self._MODEL1_VAL_DATA = os.path.join(self._DATA_DIR, "model1/Mixedmodel1_test.pth")
        else:    
